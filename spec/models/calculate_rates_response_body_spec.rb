...
# Unit tests for ShipEngine::CalculateRatesResponseBody
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'CalculateRatesResponseBody' do
  before do
    # run before each test
    @instance = ShipEngine::CalculateRatesResponseBody.new
  end
  ...
  describe 'test an instance of CalculateRatesResponseBody' do
    it 'should create an instance of CalculateRatesResponseBody' do
      expect(@instance).to be_instance_of(ShipEngine::CalculateRatesResponseBody)
    end
  end
  ...
  describe 'test attribute "order_source_code"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
