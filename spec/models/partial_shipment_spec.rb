...
# Unit tests for ShipEngine::PartialShipment
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'PartialShipment' do
  before do
    # run before each test
    @instance = ShipEngine::PartialShipment.new
  end
  ...
  describe 'test an instance of PartialShipment' do
    it 'should create an instance of PartialShipment' do
      expect(@instance).to be_instance_of(ShipEngine::PartialShipment)
    end
  end
