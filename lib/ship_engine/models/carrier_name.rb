...
module ShipEngine
  class CarrierName
    ACCESS_WORLDWIDE = "access_worldwide".freeze
    AMAZON_BUY_SHIPPING = "amazon_buy_shipping".freeze
    APC = "apc".freeze
    ASENDIA = "asendia".freeze
    AUSTRALIA_POST = "australia_post".freeze
    CANADA_POST = "canada_post".freeze
    DHL_ECOMMERCE = "dhl_ecommerce".freeze
    DHL_EXPRESS = "dhl_express".freeze
    DHL_EXPRESS_AU = "dhl_express_au".freeze
    DHL_EXPRESS_CA = "dhl_express_ca".freeze
    DHL_EXPRESS_UK = "dhl_express_uk".freeze
    DPD = "dpd".freeze
    ENDICIA = "endicia".freeze
    FEDEX = "fedex".freeze
    ...
    PUROLATOR_CANADA = "purolator_canada".freeze
    ROYAL_MAIL = "royal_mail".freeze
    RR_DONNELLEY = "rr_donnelley".freeze
    SEKO = "seko".freeze
    SENDLE = "sendle".freeze
    STAMPS_COM = "stamps_com".freeze
    UPS = "ups".freeze
