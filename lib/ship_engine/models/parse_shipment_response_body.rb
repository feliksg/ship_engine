  ...
  class ParseShipmentResponseBody
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `ShipEngine::ParseShipmentResponseBody` initialize method"
      end
    ...
    def list_invalid_properties
      ...
      if @shipment.nil?
        invalid_properties.push('invalid value for "shipment", shipment cannot be nil.')
      end
