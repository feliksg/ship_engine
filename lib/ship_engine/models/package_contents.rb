...
module ShipEngine
  class PackageContents
    ...
    def build_from_hash(value)
      constantValues = PackageContents.constants.select { |c| PackageContents::const_get(c) == value }
      raise "Invalid ENUM value #{value} for class #PackageContents" if constantValues.empty?
      value
    end
  end
end
