...
module ShipEngine
  class AncillaryServiceEndorsement
    ...
    def build_from_hash(value)
      constantValues = AncillaryServiceEndorsement.constants.select { |c| AncillaryServiceEndorsement::const_get(c) == value }
      raise "Invalid ENUM value #{value} for class #AncillaryServiceEndorsement" if constantValues.empty?
      value
    end
  end
end
