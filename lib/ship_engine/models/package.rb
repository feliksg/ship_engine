...
module ShipEngine
  ...
  class Package
    ...
    attr_accessor :external_package_id
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `ShipEngine::Package` initialize method"
      end
      ...
      if attributes.key?(:'label_messages')
        self.label_messages = attributes[:'label_messages']
      end

      if attributes.key?(:'external_package_id')
        self.external_package_id = attributes[:'external_package_id']
      end
    end
    ...
    def valid?
      ...
      return false if !@external_package_id.nil? && @external_package_id.to_s.length < 1
      true
    end

    # Custom attribute writer method with validation
    # @param [Object] external_package_id Value to be assigned
    def external_package_id=(external_package_id)
      if !external_package_id.nil? && external_package_id.to_s.length < 1
        fail ArgumentError, 'invalid value for "external_package_id", the character length must be great than or equal to 1.'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          external_package_id == o.external_package_id
    end
    ...
    def hash
      [package_code, weight, dimensions, insured_value, tracking_number, label_messages, external_package_id].hash
    end
