...
module ShipEngine
  ...
  class ShipmentItem
    ...
    # sales order item id
    attr_accessor :sales_order_item_id
    ...
    attr_accessor :external_order_item_id
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `ShipEngine::ShipmentItem` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `ShipEngine::ShipmentItem`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'sales_order_item_id')
        self.sales_order_item_id = attributes[:'sales_order_item_id']
      end
      ...
      if attributes.key?(:'external_order_item_id')
        self.external_order_item_id = attributes[:'external_order_item_id']
      end
    ...
    def valid?
      ...
      return false if !@asin.nil? && @asin.to_s.length > 10
      return false if !@asin.nil? && @asin.to_s.length < 10
      true
    end
    ...
    def asin=(asin)
      if !asin.nil? && asin.to_s.length > 10
        fail ArgumentError, 'invalid value for "asin", the character length must be smaller than or equal to 10.'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          sales_order_item_id == o.sales_order_item_id &&
          quantity == o.quantity &&
          sku == o.sku &&
          external_order_id == o.external_order_id &&
          external_order_item_id == o.external_order_item_id &&
          asin == o.asin &&
