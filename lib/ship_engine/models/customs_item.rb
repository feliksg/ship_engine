  ...
  class CustomsItem
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `ShipEngine::CustomsItem` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `ShipEngine::CustomsItem`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'customs_item_id')
      ...
      if attributes.key?(:'harmonized_tariff_code')
        self.harmonized_tariff_code = attributes[:'harmonized_tariff_code']
      else
        self.harmonized_tariff_code = 'null'
      end
    ...
    def list_invalid_properties
      ...
      if @customs_item_id.nil?
        invalid_properties.push('invalid value for "customs_item_id", customs_item_id cannot be nil.')
      end
    ...
    def valid?
      return false if @customs_item_id.nil?
    ...
    def hash
      [customs_item_id, description, quantity, value, harmonized_tariff_code, country_of_origin, unit_of_measure, sku, sku_description].hash
    end
