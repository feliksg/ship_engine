...
module ShipEngine
  ...
  class RateRequestBody
    ...
    attr_accessor :service_codes

    # Calculate the duties and tariffs for cross border shipments.
    attr_accessor :calculate_tax_amount
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `ShipEngine::RateRequestBody` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `ShipEngine::RateRequestBody`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'carrier_ids')
      ...
      if attributes.key?(:'service_codes')
        if (value = attributes[:'service_codes']).is_a?(Array)
          self.service_codes = value
        end
      end

      if attributes.key?(:'calculate_tax_amount')
        self.calculate_tax_amount = attributes[:'calculate_tax_amount']
      end
    ...
    def list_invalid_properties
      ...
      if @carrier_ids.nil?
        invalid_properties.push('invalid value for "carrier_ids", carrier_ids cannot be nil.')
      end
    ...
    def valid?
      return false if @carrier_ids.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          calculate_tax_amount == o.calculate_tax_amount &&
    ...
    def hash
      [carrier_ids, package_types, service_codes, calculate_tax_amount, preferred_currency].hash
    end
