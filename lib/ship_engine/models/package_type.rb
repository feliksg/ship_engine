  ...
  class PackageType
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `ShipEngine::PackageType` initialize method"
      end
    ...
    def list_invalid_properties
      ...
      if @package_code.nil?
        invalid_properties.push('invalid value for "package_code", package_code cannot be nil.')
      end
    ...
    def valid?
      return false if @package_code.nil?
